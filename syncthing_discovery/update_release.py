...
"""Updates Dockerfile with the latest Github Release syncthing-discosrv
version. Python 2/3 compatible.
...
def update_files():
    """Update Dockerfile with the newest version
